...
public class MyBartedListingAdapter extends RecyclerView.Adapter<MyBartedListingAdapter.MyBartingListingHolder> {
    Context context;
    ArrayList<Product> productArrayList;
    public MyBartedListingAdapter(Context context, ArrayList<Product> list) {
    ...
    public void onBindViewHolder(@NonNull final MyBartingListingHolder holder, final int position) {
        ...
        holder.listingDelete.setVisibility(View.INVISIBLE);
    }
